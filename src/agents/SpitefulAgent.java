...
public class SpitefulAgent extends Agent {
    ...
    private agentAction lastOponentAction = agentAction.C;
    ...
    protected void setup() {
        ...
        System.out.println("Spiteful Agent " + getAID().getName() + " is ready.");
    ...
    protected void takeDown() {
        ...
        ack_kill.setContent("Spiteful Player " + getAID().getName() + " terminating.");
        send(ack_kill);
    }
                ...
                switch (state) {
                    ...
                    case s2Round:
                        if (msg.getPerformative() == ACLMessage.REQUEST && msg.getContent().startsWith("Action")) {
                            ...
                            if(lastOponentAction.compareTo(agentAction.C) == 0 && trusted){
                                action = agentAction.C;
                            }
                            else{
